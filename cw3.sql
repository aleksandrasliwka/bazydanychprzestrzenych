...
SELECT NAME AS zachod, ST_Y(geom) AS wspolrzedne FROM airportsNew 
...
INSERT INTO airportsNew VALUES ('airportB', (SELECT ST_Centroid (ST_ShortestLine((SELECT geom FROM airportsNew WHERE NAME LIKE 'NOATAK'),(SELECT geom FROM airportsNew WHERE name LIKE 'NIKOLSKI')))), 67);
